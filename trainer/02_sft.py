...
def main():
    ...
    lm_config = MiniGramConfig(
        ...
        use_cache=False,
        flash_attention=True if device_type == "cuda" else 0,
    ...
    if args.resume_from and args.init_from:
        ...
        load_checkpoint(args.init_from, model, optimizer=None, scaler=None, map_location="cpu")
